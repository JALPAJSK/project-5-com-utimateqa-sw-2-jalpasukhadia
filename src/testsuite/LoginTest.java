...
public class LoginTest extends BaseTest {
    ...
    public void verifyTheErrorMessage(){
        ...
        WebElement signInLink = driver.findElement(By.linkText("Sign In"));
        signInLink.click();
        //Find username filed element and enter "jalpajsk@yahoo.com" username
         WebElement Username = driver.findElement(By.id("user[email]"));
         Username.sendKeys("jalpajsk24@yahoo.com");
        //Find password filed element and enter “Kri123456” password
         WebElement Password = driver.findElement(By.id("user[password]"));
         Password.sendKeys("Kri12345685");
